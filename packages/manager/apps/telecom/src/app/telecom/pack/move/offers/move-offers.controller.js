...
export default class PackMoveOffersCtrl {
    ...
    this.OvhApiPackXdslMove.v6()
      ...
      .then((offers) => {
        if (offers.status === 'error') {
          ...
          listOffers = offers.result.offers;
        }
          ...
          this.OvhApiPackXdslMove.v6()
            ...
            .then((fiberOffers) => {
              if (fiberOffers === 'error') {
                ...
                listOffersFiber = fiberOffers.result.offers;
                this.offers = [...listOffers, ...listOffersFiber];
              }
  ...
  isOptionAvailable(offer, optionName) {
